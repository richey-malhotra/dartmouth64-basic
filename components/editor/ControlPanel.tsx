...
export function ControlPanel(props: ControlPanelProps) {
  ...
  return (
    <div className="relative z-20 w-full">
      <div className="glass-panel-strong card-surface accent-glow bg-gradient-to-r from-[#101322]/92 via-[#111727]/78 to-transparent border border-white/10 shadow-[0_25px_45px_-30px_rgba(15,23,42,0.9)] transition-shadow duration-500 overflow-hidden px-[3px] py-2 flex flex-wrap lg:flex-nowrap items-center gap-2.5 lg:gap-3.5 lg:justify-between">
        {/* Execution Controls */}
        <div
          className={cn(
            controlGroupBase,
