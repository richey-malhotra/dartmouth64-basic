...
export function InputPanel({ prompt, isAwaitingInput, onSubmit }: InputPanelProps) {
  ...
  return (
  <div className="h-full flex flex-col glass-panel card-surface border border-surface-divider/85 shadow-[0_22px_50px_-32px_rgba(12,23,40,0.85)] bg-gradient-to-r from-white/6 via-white/4 to-transparent p-4 gap-3">
      ...
      <form onSubmit={handleSubmit} className="flex-1 flex items-start gap-3 min-h-0">
        <Textarea
          ...
          className="h-full flex-1 font-mono text-sm glass-panel-strong card-surface border border-surface-divider/90 shadow-[inset_0_0_0_1px_rgba(75,192,255,0.12)] bg-[color:rgba(10,16,26,0.88)] text-foreground/90 focus:ring-2 focus:ring-accentCyan/60 focus:border-accentCyan/60 resize-none transition-shadow"
